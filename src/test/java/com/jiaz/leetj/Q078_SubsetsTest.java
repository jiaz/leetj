...
public class Q078_SubsetsTest extends AbstractTestII<Q078_Subsets, List<List<Integer>>> {
    ...
    @Override
    protected List<List<Integer>> solveProblem(String input, Q078_Subsets solver) {
        return solver.subsets(toIntArray(input));
    }
}
