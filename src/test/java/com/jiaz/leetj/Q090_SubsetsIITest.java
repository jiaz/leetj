...
public class Q090_SubsetsIITest extends AbstractTestII<Q090_SubsetsII, List<List<Integer>>> {
    ...
    @Override
    protected List<List<Integer>> solveProblem(String input, Q090_SubsetsII solver) {
        return solver.subsetsWithDup(toIntArray(input));
    }
