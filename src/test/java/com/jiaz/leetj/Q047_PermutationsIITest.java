...
public class Q047_PermutationsIITest extends AbstractTestII<Q047_PermutationsII, List<List<Integer>>> {
    ...
    @Override
    protected List<List<Integer>> solveProblem(String input, Q047_PermutationsII solver) {
        return solver.permuteUnique(toIntArray(input));
    }
